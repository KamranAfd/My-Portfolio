        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            <form className="space-y-6">
              ...
              <div>
                ...
                <select id="project-type" name="project-type" className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
              ...
              <div>
                <button type="submit" className="w-full bg-blue-500 text-white px-6 py-3 rounded-md text-lg font-semibold hover:bg-blue-600 transition duration-300">Send Message</button>
              </div>
            </form>
          </div>
          <div className="space-y-6">
            <div className="flex items-center">
              ...
              <span>contact@kamranedits.com</span>
            </div>
            <div className="flex items-center">
